...
def process_health_data():
    ...
    feature_limits[1][0] = min(X_health[:, 1])
    feature_limits[1][1] = max(X_health[:, 1])
    feature_limits[2][0] = min(X_health[:, 2])
    feature_limits[2][1] = max(X_health[:, 2])
    feature_limits[3][0] = min(X_health[:, 3])
    feature_limits[3][1] = max(X_health[:, 3])
